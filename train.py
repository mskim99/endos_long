...
def main(args, port, pretrained_weights, mode, prr_weight):
    ...
    if args.resume_from_checkpoint:
        ...
        # model.module.load_state(os.path.join(dirs, path))
        states = torch.load('/data/jionkim/Endora/results/003-EnDoraIMG-XL-2-F16S3-endoslam_img/checkpoints/0110000.pt')
        model.module.load_state_dict(states['ema'])
        del states
        train_steps = 110000

        first_epoch = train_steps // num_update_steps_per_epoch
        resume_step = train_steps
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=6034)
